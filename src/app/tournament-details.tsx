    ...
    <View style={styles.tabContent}>
      ...
      <View style={[styles.infoCard, { backgroundColor: theme.surfaceLow }]}>
        ...
        <View style={{ marginLeft: 12, flex: 1 }}>
          <ThemedText type="bodySm" style={{ fontWeight: '500', color: theme.text }}>Elms Field Ground A</ThemedText>
      ...
      <View style={[styles.infoCard, { backgroundColor: theme.surfaceLow }]}>
        ...
        <View style={{ marginLeft: 12, flex: 1 }}>
          <ThemedText type="bodySm" style={{ fontWeight: '500', color: theme.text }}>Apex Sports Club</ThemedText>
      ...
      <View style={styles.fixturesList}>
        {[
          ...
          <View key={idx} style={[styles.fixtureCard, { backgroundColor: theme.surfaceLowest, borderColor: theme.outlineVariant + '33' }]}>
            <View style={styles.rowBetween}>
              <ThemedText type="labelSm" style={{ color: theme.textSecondary, fontWeight: '500' }}>{fix.match} • {fix.date}</ThemedText>
      ...
      {tournamentSport === 'Cricket' ? (
        ...
        <View style={[styles.liveScoreCard, { backgroundColor: theme.primaryContainer }]}>
          ...
          <View style={styles.cricketScores}>
            <View style={{ flex: 1 }}>
              <ThemedText type="bodyLg" style={{ color: '#ffffff', fontWeight: '500' }}>Apex Warriors</ThemedText>
            ...
            <View style={{ flex: 1, alignItems: 'flex-end' }}>
              <ThemedText type="bodyLg" style={{ color: '#ffffff', fontWeight: '500' }}>Titans CC</ThemedText>
      ...
      <View style={styles.sponsorsGrid}>
        {[
          ...
          <View key={idx} style={[styles.sponsorCard, { backgroundColor: theme.surfaceLowest, borderColor: theme.outlineVariant + '33' }]}>
            ...
            <ThemedText type="bodySm" style={{ fontWeight: '500', marginTop: 8, color: theme.text, textAlign: 'center' }}>
              {sp.name}
            </ThemedText>
        ...
        <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={styles.scrollContent}>
          ...
          <View style={styles.bannerContainer}>
            ...
            <View style={styles.countdownBadge}>
              ...
              <ThemedText type="labelSm" style={{ color: '#ffffff', fontWeight: '500' }}>
