    ...
    <ThemedView style={styles.container}>
      <SafeAreaView style={styles.safeArea}>
        <View style={styles.header}>
          <ThemedText type="headlineLg">Explore Venues</ThemedText>
        </View>
        <View style={styles.content}>
          ...
          <ThemedText type="headlineSm" style={{ marginTop: Spacing.md, color: theme.text }}>
            Explore Arena Catalog
          </ThemedText>
          <ThemedText type="bodyMd" style={{ color: theme.textSecondary, textAlign: 'center', marginTop: Spacing.xs }}>
            Search local venues, view active leagues, and filter by your favorite sports in London.
          </ThemedText>
        </View>
      </SafeAreaView>
    </ThemedView>
