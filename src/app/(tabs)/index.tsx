                ...
                <View style={styles.section}>
                  ...
                  <View style={[styles.graphCard, { backgroundColor: theme.surfaceLowest, marginBottom: Spacing.md, padding: 16 }, Shadows.level2]}>
                    ...
                    <View style={styles.graphHeader}>
                      <View style={{ flex: 1 }}>
                        <ThemedText type="labelMd" style={{ color: theme.text, fontFamily: 'Sora_500Medium', letterSpacing: 0.5, fontSize: 14 }}>
                          Weekly Coached Hours (Activity Load)
                        </ThemedText>
                        <View style={{ flexDirection: 'row', alignItems: 'center', marginTop: 3, gap: 8 }}>
                          <ThemedText type="labelSm" style={{ color: '#10b981', fontFamily: 'Sora_500Medium', fontSize: 12 }}>
                            32.5 Hours Total
                          </ThemedText>
                          <View style={{ backgroundColor: '#10b9811F', paddingHorizontal: 6, paddingVertical: 2, borderRadius: 4 }}>
                            <ThemedText style={{ color: '#047857', fontSize: 9, fontFamily: 'Sora_500Medium' }}>
                              🔥 Peak: Fri (7.0h)
                            </ThemedText>
                          </View>
                        </View>
                        ...
                        {[
                          ...
                          return (
                            <View key={idx} style={{ flex: 1, alignItems: 'center', justifyContent: 'flex-end', height: '100%' }}>
                              ...
                              <ThemedText style={{ color: isActive ? '#047857' : theme.textSecondary, fontSize: 9, fontFamily: 'Sora_500Medium', marginBottom: 4 }}>
                                {bar.display}
                              </ThemedText>
                    ...
                    <View style={{ flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', marginTop: 10, paddingTop: 8, borderTopWidth: 1, borderTopColor: theme.outlineVariant + '1A' }}>
                      <ThemedText style={{ color: theme.textSecondary, fontSize: 10 }}>
                        Daily Avg: <ThemedText style={{ color: theme.text, fontFamily: 'Sora_500Medium' }}>4.6 hrs/day</ThemedText>
                      </ThemedText>
                      <ThemedText style={{ color: '#047857', fontSize: 10, fontFamily: 'Sora_500Medium' }}>
                  ...
                  <View style={[styles.graphCard, { backgroundColor: theme.surfaceLowest, padding: 16 }, Shadows.level2]}>
                    ...
                    <View style={styles.graphHeader}>
                      <View style={{ flex: 1 }}>
                        ...
                        <View style={{ flexDirection: 'row', alignItems: 'center', marginTop: 3, gap: 8 }}>
                          <ThemedText type="labelSm" style={{ color: '#ff8c00', fontFamily: 'Sora_500Medium', fontSize: 12 }}>
                            Avg. 82% Enrollment
                          </ThemedText>
                          <View style={{ backgroundColor: '#ff8c001F', paddingHorizontal: 6, paddingVertical: 2, borderRadius: 4 }}>
                            <ThemedText style={{ color: '#c2410c', fontSize: 9, fontFamily: 'Sora_500Medium' }}>
                              🏆 Top: Weekend (95%)
                            </ThemedText>
                          </View>
                        </View>
                        ...
                        {[
                          ...
                          return (
                            <View key={idx} style={{ flex: 1, alignItems: 'center', justifyContent: 'flex-end', height: '100%' }}>
                              ...
                              <ThemedText style={{ color: isActive ? '#c2410c' : theme.textSecondary, fontSize: 9, fontFamily: 'Sora_500Medium', marginBottom: 4 }}>
                                {bar.display}
                              </ThemedText>
                    ...
                    <View style={{ flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', marginTop: 10, paddingTop: 8, borderTopWidth: 1, borderTopColor: theme.outlineVariant + '1A' }}>
                      ...
                      <ThemedText style={{ color: '#c2410c', fontSize: 10, fontFamily: 'Sora_500Medium' }}>
                  ...
                  >
                    <View style={styles.planInfo}>
                      ...
                      <Pressable
                        ...
                        onPress={() => router.push('/coach-students')}
                      >
                        <ThemedText type="labelMd" style={{ color: theme.primary, fontFamily: 'Sora_500Medium' }}>
                          View Students
                        </ThemedText>
                      </Pressable>
                    </View>
                      ...
                      {classes.map((cls, idx) => {
                        ...
                        return (
                          ...
                          >
                            ...
                            <ThemedText type="title" style={{ color: theme.text, fontFamily: 'Sora_500Medium', fontSize: 15, lineHeight: 20 }} numberOfLines={1}>
                              {cls.className}
                            </ThemedText>
                      ...
                      <View style={{ zIndex: 2, flex: 1, justifyContent: 'space-between' }}>
                        <View style={{ flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center' }}>
                          ...
                          <View style={{ backgroundColor: 'rgba(255, 255, 255, 0.15)', paddingHorizontal: 7, paddingVertical: 3, borderRadius: BorderRadius.sm, borderWidth: 1, borderColor: 'rgba(255, 255, 255, 0.2)' }}>
                            <ThemedText style={{ color: '#ffffff', fontSize: 8.5, fontFamily: 'Sora_500Medium', letterSpacing: 0.6 }}>
                              BATCH CREATOR
                            </ThemedText>
                          </View>
                        </View>
                        ...
                        >
                          <ThemedText style={{ color: '#4338ca', fontSize: 11, fontFamily: 'Sora_500Medium', marginRight: 4 }}>
                            + Add Class
                          </ThemedText>
                      ...
                      <View style={{ zIndex: 2, flex: 1, justifyContent: 'space-between' }}>
                        <View style={{ flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center' }}>
                          ...
                          <View style={{ backgroundColor: 'rgba(245, 158, 11, 0.2)', paddingHorizontal: 7, paddingVertical: 3, borderRadius: BorderRadius.sm, borderWidth: 1, borderColor: 'rgba(251, 191, 36, 0.3)' }}>
                            <ThemedText style={{ color: '#fbbf24', fontSize: 8.5, fontFamily: 'Sora_500Medium', letterSpacing: 0.6 }}>
                              COACH SLOTS
                            </ThemedText>
                          </View>
                        </View>
                        ...
                        >
                          <ThemedText style={{ color: '#ffffff', fontSize: 11, fontFamily: 'Sora_500Medium', marginRight: 4 }}>
                            Set Slots
                          </ThemedText>
              ...
              <>
                ...
                <View style={styles.section}>
                  <View style={[styles.graphCard, { backgroundColor: theme.surfaceLowest, padding: 16, borderRadius: 12 }, Shadows.level2]}>
                    <View style={styles.graphHeader}>
                      <View style={{ flex: 1 }}>
                        <ThemedText type="labelMd" style={{ color: theme.text, fontFamily: 'Sora_500Medium', letterSpacing: 0.5, fontSize: 13.5 }}>
                          Weekly Revenue Trend (₹)
                        </ThemedText>
                        <ThemedText style={{ color: '#10b981', fontSize: 10, fontFamily: 'Sora_500Medium', marginTop: 2 }}>
                  ...
                  <View style={styles.bentoRow}>
                    ...
                    <View style={[{ flex: 1, borderRadius: 12, padding: 14, minHeight: 145, justifyContent: 'space-between', backgroundColor: theme.surfaceLowest, borderColor: theme.outlineVariant + '33', borderWidth: 1, position: 'relative', overflow: 'hidden' }, Shadows.level2]}>
                      ...
                      <View style={{ flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', zIndex: 2 }}>
                        ...
                        <ThemedText style={{ color: '#10b981', fontSize: 10, fontFamily: 'Sora_500Medium' }}>
                          +15% vs Wk
                        </ThemedText>
                      </View>
                      ...
                      <View style={{ borderTopWidth: 1, borderTopColor: theme.outlineVariant + '20', paddingTop: 6, marginTop: 6, zIndex: 2 }}>
                        ...
                        <ThemedText style={{ fontSize: 8.5, color: '#10b981', fontFamily: 'Sora_500Medium', marginTop: 2 }}>
                          🔥 Peak Demand: 6 - 9 PM
                        </ThemedText>
                      </View>
                    </View>
                    ...
                    <View style={[{ flex: 1, borderRadius: 12, padding: 14, minHeight: 145, justifyContent: 'space-between', backgroundColor: theme.primaryContainer, position: 'relative', overflow: 'hidden' }, Shadows.level3]}>
                      ...
                      <View style={{ flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', zIndex: 2 }}>
                        ...
                        <ThemedText style={{ color: 'rgba(255, 255, 255, 0.85)', fontSize: 9.5, fontFamily: 'Sora_500Medium' }}>
                          3 Pending
                        </ThemedText>
                      </View>
                      ...
                      <View style={{ borderTopWidth: 1, borderTopColor: 'rgba(255, 255, 255, 0.15)', paddingTop: 6, marginTop: 6, zIndex: 2 }}>
                        <ThemedText style={{ fontSize: 9, color: 'rgba(255, 255, 255, 0.85)', fontFamily: 'Sora_500Medium' }}>
                          Overdue: ₹1,400 (2 Reminders Sent)
                        </ThemedText>
                        <ThemedText style={{ fontSize: 8.5, color: '#fbbf24', fontFamily: 'Sora_500Medium', marginTop: 2 }}>
                          ⚡ Action Required
                        </ThemedText>
                      </View>
                    </View>
                      ...
                      >
                        ...
                        <View style={styles.featuredTurfContent}>
                          <View style={styles.featuredTurfHeader}>
                            <ThemedText type="labelSm" style={{ color: theme.secondary, fontWeight: '500', fontSize: 9 }} numberOfLines={1}>
                          ...
                          <View style={styles.featuredTurfFooter}>
                            <View style={{ backgroundColor: pitch.statusColor + '15', paddingHorizontal: 6, paddingVertical: 2, borderRadius: 4 }}>
                              <ThemedText type="labelSm" style={{ color: pitch.statusColor, fontSize: 9, fontFamily: 'Sora_500Medium' }}>
                                {pitch.status}
                              </ThemedText>
                ...
                <View style={styles.section}>
                  <View style={styles.sectionHeader}>
                    ...
                    <Pressable>
                      <ThemedText type="labelMd" style={{ color: theme.secondary, fontFamily: 'Sora_500Medium', fontSize: 10.5 }}>
                        Full Schedule
                      </ThemedText>
                    </Pressable>
                  </View>
                    ...
                    <View style={[{ flexDirection: 'row', alignItems: 'flex-start', padding: 14, borderRadius: 10, backgroundColor: theme.surfaceLowest, borderColor: theme.outlineVariant + '25', borderWidth: 1 }, Shadows.level2]}>
                      ...
                      <View style={{ flex: 1, marginHorizontal: 8, gap: 4 }}>
                        <View style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between' }}>
                          <ThemedText type="headlineSm" style={{ fontSize: 12, fontFamily: 'Sora_500Medium', color: theme.text, flex: 1, marginRight: 6 }} numberOfLines={1}>
                            Footy Club Match Booking
                          </ThemedText>
                          <ThemedText style={{ fontSize: 8, fontFamily: 'Sora_500Medium', color: theme.textSecondary }}>#B902</ThemedText>
                        </View>
                        ...
                        <View style={{ flexDirection: 'row', alignItems: 'center', flexWrap: 'wrap', gap: 5, marginTop: 3, paddingTop: 4, borderTopWidth: 1, borderTopColor: theme.outlineVariant + '15' }}>
                          ...
                          <ThemedText style={{ color: '#10b981', fontSize: 8.5, fontFamily: 'Sora_500Medium' }}>
                            Fully Paid
                          </ThemedText>
                      ...
                      <ThemedText style={{ fontSize: 8, fontFamily: 'Sora_500Medium', color: '#ef4444', letterSpacing: 0.5, alignSelf: 'flex-start' }}>LIVE</ThemedText>
                    </View>
                    ...
                    <View style={[{ flexDirection: 'row', alignItems: 'flex-start', padding: 14, borderRadius: 10, backgroundColor: theme.surfaceLowest, borderColor: theme.outlineVariant + '25', borderWidth: 1 }, Shadows.level2]}>
                      ...
                      <View style={{ flex: 1, marginHorizontal: 8, gap: 4 }}>
                        <View style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between' }}>
                          ...
                          <ThemedText style={{ fontSize: 8, fontFamily: 'Sora_500Medium', color: theme.textSecondary }}>#B211</ThemedText>
                        </View>
                        ...
                        <View style={{ flexDirection: 'row', alignItems: 'center', flexWrap: 'wrap', gap: 5, marginTop: 3, paddingTop: 4, borderTopWidth: 1, borderTopColor: theme.outlineVariant + '15' }}>
                          ...
                          <ThemedText style={{ color: '#d97706', fontSize: 8.5, fontFamily: 'Sora_500Medium' }}>
                            Advance Paid (₹1,000)
                          </ThemedText>
                          <ThemedText style={{ color: '#ef4444', fontSize: 8.5, fontFamily: 'Sora_500Medium' }}>
                            · ₹2,600 Due at Turf
                          </ThemedText>
                        </View>
                      </View>

                      <ThemedText style={{ fontSize: 8, fontFamily: 'Sora_500Medium', color: '#f59e0b', letterSpacing: 0.5, alignSelf: 'flex-start' }}>UPCOMING</ThemedText>
                    </View>
                  </View>
                </View>
                    ...
                    >
                      ...
                      >
                        ...
                        <View style={{ flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', zIndex: 2 }}>
                          ...
                          <ThemedText style={{ color: 'rgba(255, 255, 255, 0.9)', fontFamily: 'Sora_500Medium', fontSize: 8.5, letterSpacing: 0.5 }}>
                            SLOT CREATOR
                          </ThemedText>
                        </View>

                        <View style={{ marginVertical: 4, zIndex: 2 }}>
                          <ThemedText style={{ color: '#ffffff', fontSize: 15, fontFamily: 'Sora_500Medium', lineHeight: 19 }}>
                            Create Slot
                          </ThemedText>
                        ...
                        <View style={{ alignSelf: 'flex-start', backgroundColor: '#ffffff', paddingHorizontal: 12, paddingVertical: 6, borderRadius: 16, zIndex: 2 }}>
                          <ThemedText style={{ color: '#3c397b', fontFamily: 'Sora_500Medium', fontSize: 9.5 }}>
                            + Add Slot →
                          </ThemedText>
                        </View>
                      </LinearGradient>
                    ...
                    >
                      ...
                      >
                        ...
                        <View style={{ flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', zIndex: 2 }}>
                          ...
                          <ThemedText style={{ color: '#fbbf24', fontFamily: 'Sora_500Medium', fontSize: 8.5, letterSpacing: 0.5 }}>
                            COACH SLOTS
                          </ThemedText>
                        </View>
                        ...
                        <View style={{ alignSelf: 'flex-start', backgroundColor: '#f59e0b', paddingHorizontal: 12, paddingVertical: 6, borderRadius: 16, zIndex: 2 }}>
                          <ThemedText style={{ color: '#ffffff', fontFamily: 'Sora_500Medium', fontSize: 9.5 }}>
                            Set Rates →
                          </ThemedText>
                        </View>
                      </LinearGradient>
                      ...
                      {[
                        ...
                        >
                          ...
                          <View style={{ paddingHorizontal: 12, paddingTop: 10 }}>
                            <ThemedText type="headlineSm" style={{ color: theme.text, fontFamily: 'Sora_500Medium', fontSize: 15 }} numberOfLines={1}>
                              {student.name}
                            </ThemedText>

                            <ThemedText style={{ color: theme.primary, fontSize: 11, fontFamily: 'Sora_500Medium', marginTop: 2 }} numberOfLines={1}>
                            ...
                            <View style={{ flexDirection: 'row', alignItems: 'center', marginTop: 8, paddingTop: 8, borderTopWidth: 1, borderTopColor: theme.outlineVariant + '1F' }}>
                              ...
                              <ThemedText style={{ color: theme.textSecondary, fontSize: 10 }}>
                                Att: <ThemedText style={{ color: theme.text, fontFamily: 'Sora_500Medium', fontSize: 10 }}>{student.attendance}</ThemedText>
                              </ThemedText>
                            </View>
                          </View>
                        </Pressable>
                          ...
                          <View style={styles.featuredTurfContent}>
                            <View style={styles.featuredTurfHeader}>
                              ...
                              <View style={styles.featuredTurfRating}>
                                ...
                                <ThemedText type="labelSm" style={{ marginLeft: 2, fontFamily: 'Sora_500Medium', fontSize: 10 }}>{turf.rating}</ThemedText>
                              </View>
                            </View>
                            <ThemedText type="headlineSm" style={[styles.featuredTurfTitle, { color: theme.text }]} numberOfLines={1}>
                              {turf.name}
                            ...
                            <View style={styles.featuredTurfFooter}>
                              <View style={{ flexDirection: 'row', alignItems: 'baseline' }}>
                                <ThemedText type="headlineSm" style={{ color: theme.secondary, fontSize: 13, fontFamily: 'Sora_500Medium' }}>{turf.price}</ThemedText>
                              ...
                              >
                                <ThemedText type="labelSm" style={{ color: theme.onSecondaryContainer, fontSize: 10, fontFamily: 'Sora_500Medium' }}>Book</ThemedText>
                              </Pressable>
                            </View>
                          </View>
                        </Pressable>
                    ...
                    <View style={styles.scheduleList}>
                        ...
                        <View style={styles.scheduleInfo}>
                          ...
                          <View style={styles.scheduleDetailsRow}>
                            <ThemedText type="bodyMd" style={styles.scheduleDetailsText}>
                              ₹1,200 • <ThemedText type="bodyMd" style={{ color: '#10b981', fontFamily: 'Sora_500Medium' }}>Paid</ThemedText>
                            </ThemedText>
                          </View>
                        </View>
                      </View>
                      ...
                      <View style={[styles.scheduleCard, { backgroundColor: theme.surfaceLowest }, Shadows.level1]}>
                        ...
                        <View style={styles.scheduleInfo}>
                          ...
                          <View style={styles.scheduleDetailsRow}>
                            <ThemedText type="bodyMd" style={styles.scheduleDetailsText}>
                              ₹1,800 • <ThemedText type="bodyMd" style={{ color: '#ff1744', fontFamily: 'Sora_500Medium' }}>Unpaid</ThemedText>
                            </ThemedText>
                          </View>
                        </View>
                      </View>
                  ...
                  <View style={styles.section}>
                    <View style={styles.actionCardsRow}>
                      ...
                      >
                        ...
                        >
                          <ThemedText type="labelMd" style={{ color: theme.primary, fontFamily: 'Sora_500Medium', fontSize: 11 }}>
                            Add Slot
                          </ThemedText>
                        </Pressable>
                      </Pressable>
                      ...
                      >
                        ...
                        >
                          <ThemedText type="labelMd" style={{ color: '#ffffff', fontFamily: 'Sora_500Medium', fontSize: 11 }}>
                            Set Rates
                          </ThemedText>
                        </Pressable>
                      </Pressable>
                    ...
                    >
                      ...
                      <View style={{ flex: 1 }}>
                        <ThemedText style={{ color: theme.text, fontSize: 13.5, fontFamily: 'Sora_500Medium' }}>
                          Vouchers & Offers
                        </ThemedText>
                        <ThemedText
                ...
                <View style={[styles.section, { paddingBottom: 100 }]}>
                  {role === 'Owner' ? (
                    ...
                    <View style={[styles.graphCard, { backgroundColor: theme.surfaceLowest }, Shadows.level2]}>
                      <View style={styles.graphHeader}>
                        <ThemedText type="labelMd" style={{ color: theme.text, fontFamily: 'Sora_500Medium', letterSpacing: 0.5 }}>
                      ...
                      <View style={styles.graphBarsContainer}>
                        ...
                        <View style={styles.graphBarCol}>
                          ...
                          <ThemedText type="labelSm" style={[styles.graphBarLabel, { color: theme.secondary, fontFamily: 'Sora_500Medium' }]}>S</ThemedText>
                        </View>
                        <View style={styles.graphBarCol}>
                    ...
                    <View style={[styles.graphCard, { backgroundColor: theme.surfaceLowest }, Shadows.level2]}>
                      ...
                      <View style={styles.graphBarsContainer}>
                        ...
                        <View style={styles.graphBarCol}>
                          ...
                          <ThemedText type="labelSm" style={[styles.graphBarLabel, { color: theme.secondary, fontFamily: 'Sora_500Medium' }]}>T</ThemedText>
                        </View>
                        <View style={styles.graphBarCol}>
                    ...
                    <View style={[styles.graphCard, { backgroundColor: theme.surfaceLowest }, Shadows.level2]}>
                      ...
                      <View style={styles.graphBarsContainer}>
                        ...
                        <View style={styles.graphBarCol}>
                          ...
                          <ThemedText type="labelSm" style={[styles.graphBarLabel, { color: theme.secondary, fontFamily: 'Sora_500Medium' }]}>W</ThemedText>
                        </View>
                        <View style={styles.graphBarCol}>
                          <View style={[styles.graphBar, { height: 90, backgroundColor: theme.primary }]} />
                          <ThemedText type="labelSm" style={styles.graphBarLabel}>T</ThemedText>
