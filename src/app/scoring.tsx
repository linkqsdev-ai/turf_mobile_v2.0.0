            ...
            {SPORTS_LIST.map((sport) => {
              ...
              return (
                ...
                >
                  ...
                  <ThemedText style={{ color: isActive ? W : theme.textSecondary, fontFamily: 'Sora_600SemiBold', fontSize: 11 }}>
                    {sport.name}
                  </ThemedText>
                </Pressable>
              );
            ...
            <View style={{ backgroundColor: BG, borderTopLeftRadius: 26, borderTopRightRadius: 26, maxHeight: '92%', overflow: 'hidden' }}>
              ...
              {loading ? (
                <View style={{ flex: 1, justifyContent: 'center', alignItems: 'center', paddingVertical: 60 }}>
                  ...
                  <ThemedText style={{ marginTop: 12, color: P, fontFamily: 'Sora_600SemiBold', fontSize: 13 }}>
                    Loading stats…
                  </ThemedText>
                </View>
              ) : (
