...
const styles = StyleSheet.create({
  ...
  // next session
  sessionCard: { height: 116, borderRadius: BorderRadius.lg, borderWidth: 1, overflow: 'hidden' },
  sessionArt: {
    position: 'absolute',
    right: -18,
    bottom: -14,
  ...
  sessionBody: { flex: 1, justifyContent: 'space-between', padding: Spacing.sm },
  sessionTopRow: { flexDirection: 'row', alignItems: 'center', gap: 6 },
  statusPill: {
    flexDirection: 'row',
    alignItems: 'center',
    gap: 4,
  ...
  venueName: { fontFamily: 'Sora_500Medium', fontSize: 13.5 },
  ...
  emptyTitle: { fontFamily: 'Sora_500Medium', fontSize: 13, marginTop: 3 },
  emptyBody: { fontFamily: 'Sora_400Regular', fontSize: 11, textAlign: 'center' },
  emptyBtn: {
    marginTop: 8,
  ...
  // bid match
  bidCard: { borderRadius: BorderRadius.lg, borderWidth: 1, overflow: 'hidden' },
  bidArt: { position: 'absolute', right: -20, top: -8, width: 120, height: 120, opacity: 0.9 },
  bidBody: { padding: Spacing.sm },
  bidTitleRow: { flexDirection: 'row', alignItems: 'center', gap: 6 },
  bidTitle: { fontFamily: 'Sora_500Medium', fontSize: 13.5 },
  bidSub: { fontFamily: 'Sora_400Regular', fontSize: 10.5, marginTop: 2, lineHeight: 14 },
  livePill: {
    alignSelf: 'flex-start',
    marginTop: 6,
    paddingHorizontal: 7,
  ...
  livePillText: { fontFamily: 'Sora_500Medium', fontSize: 9 },
  bidActions: { flexDirection: 'row', gap: 6, marginTop: Spacing.sm },
  bidBtn: {
    flex: 1,
    height: 32,
    borderRadius: 999,
  ...
  bidBtnText: { color: '#ffffff', fontFamily: 'Sora_500Medium', fontSize: 11 },
  bidBtnGhost: {
    flex: 1,
    height: 32,
    borderRadius: 999,
  ...
  bidBtnGhostText: { fontFamily: 'Sora_500Medium', fontSize: 11 },
  ...
  progressValue: { fontFamily: 'Sora_500Medium', fontSize: 11 },
  ...
  recordValue: { fontFamily: 'Sora_500Medium', fontSize: 15 },
  recordLabel: {
    fontFamily: 'Sora_500Medium',
    fontSize: 8.5,
    letterSpacing: 0.6,
